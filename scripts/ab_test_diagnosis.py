...
请分析以下客户的聊天记录，输出JSON格式（不要输出其他内容）：
{{
  "stage": "客户所处阶段",
  "purchase_probability": "高/中/低",
  "key_signal": "你判断的核心依据（一句话）",
  "suggestion": "下一步跟进建议（一句话，具体可执行）",
  "risk": "流失风险信号（如有，没有则为null）"
}}

stage必须是以下12个之一：
初次接触、需求了解、风格确认、产品推荐、报价阶段、面料选择、尺寸确认、定金已付、尾款跟进、已成交、沉默流失、明确拒绝
